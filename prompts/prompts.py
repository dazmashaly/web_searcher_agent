...
the plan could be more than one search , if neecessary generate the sequence of searches.
Here is your previous plan: `{plan}`

Here is the feedback: `{feedback}`

You MUST carefully consider the feedback and adjust or change your plan based on the feedback provided if it answers a step remove the step from the plan.
...
dont answer the query, only generate the questions
"""
...
Do not use any external sources or video sources like youtube or tiktok.
Example Response:
...
Do not select the same source you selected before.
...
6. make sure that the reason is short.
...
The json object should have the following format: dont mention that its a json object in the response just return the json object    
{
    'pass': 'True' or 'False'
...
dont return anything other than the json object, dont mention that its a json object in the response
"""
...
dont return anything other than the json object
"""
...
Do not select any of the failed sites again sites
...
dont return anything other than the json object
Do not select any of the failed sites again sites
Do not select any of the visited sites again sites
"""
